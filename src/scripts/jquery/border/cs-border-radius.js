module.exports = {
  handle: function(options) {
    ...
    if ($) {
       ...
       ** -khtml-border-radius: For old Konqueror browser
       ** behavior: IE 6-8
       */
      $(selector).css('border-radius', valueCss)
        .css('-moz-border-radius', valueCss)
        .css('-webkit-border-radius', valueCss)
        .css('-khtml-border-radius', valueCss)
