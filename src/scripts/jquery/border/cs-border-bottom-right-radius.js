module.exports = {
  handle: function(options) {
    ...
    if ($) {
       ...
       ** behavior: IE 6-8
       */
      $(selector).css('border-bottom-right-radius', valueCss)
        .css('-moz-border-bottom-right-radius', valueCss)
        .css('-webkit-border-bottom-right-radius', valueCss)
        .css('-khtml-border-bottom-right-radius', valueCss)
