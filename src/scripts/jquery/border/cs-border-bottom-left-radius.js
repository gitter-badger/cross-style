module.exports = {
  handle: function(options) {
    ...
    if ($) {
       ...
       ** behavior: IE 6-8
       */
      $(selector).css('border-bottom-left-radius', valueCss)
        .css('-moz-border-bottom-left-radius', valueCss)
        .css('-webkit-border-bottom-left-radius', valueCss)
        .css('-khtml-border-bottom-left-radius', valueCss)
